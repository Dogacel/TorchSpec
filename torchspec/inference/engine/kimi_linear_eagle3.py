...
class KimiLinearForCausalLMEagle3(KimiLinearForCausalLM, SupportsEagle3):
    ...
    def __init__(self, *, vllm_config, prefix: str = ""):
        ...
        # Both classes have identical state/layout; the subclass only replaces
        # forward and adds EagleModelMixin's capture bookkeeping.
        self.model.__class__ = KimiLinearModelEagle3
